...
#define MICROPY_BOARD_EARLY_INIT COLUMBUS_board_early_init
void COLUMBUS_board_early_init(void);
...
#include "sram.h"
#define MICROPY_HEAP_START  ( sram_is_valid() ? sram_start() : &_heap_start)
#define MICROPY_HEAP_END    ( sram_is_valid() ? sram_end() : &_heap_end)
