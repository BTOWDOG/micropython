...
namespace dl
{
    namespace image
    {
        ...
        void draw_filled_rectangle(unsigned char*, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int color = 0x00FF0000);
        /**
        ...
        void draw_filled_rectangle(unsigned short*, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned short color = 0b0001111100000000);
        /**
        ...
        //                 const uint32_t color = 0x00FF0000);
        void draw_point(unsigned char*, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int color = 0x00FF0000);
        /**
        ...
        void draw_point(unsigned short*, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned short color = 0b0001111100000000);
        /**
        ...
        void draw_hollow_rectangle(unsigned char*, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int color = 0x00FF0000);
        /**
        ...
        //                            uint32_t x1, uint32_t y1, uint32_t x2, uint32_t y2,
        //                            const uint16_t color = 0b0001111100000000);
        void draw_hollow_rectangle(unsigned short*, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned short color = 0b0001111100000000);
        /**
        ...
        uint32_t get_moving_point_number(unsigned char*, unsigned char*, unsigned int, unsigned int, unsigned int, unsigned int);
        /**
         * @brief Detect target moving by activated detection point number. Each cross in the figure below is a detection point.
         * Once abs(frame_1_detection_point[i] - frame_2_detection_point[i]) > threshold, this detection point is activated.
         * This function will return the number of activated detection point.
        ...
        uint32_t get_moving_point_number(unsigned short*, unsigned short*, unsigned int, unsigned int, unsigned int, unsigned int);
        /**
